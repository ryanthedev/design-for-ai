...
description: "Identifies, classifies, and proposes honest alternatives to deceptive design patterns — manipulative UX techniques that exploit psychology against user intent. Use when the question is about dark patterns, deceptive patterns, manipulative UX, whether something is a dark pattern, urgency manipulation, false scarcity, countdown timers, confirmshaming, roach motels, trick questions, hidden costs, drip pricing, friction asymmetry, fake reviews, default exploitation, bait-and-switch, disguised ads, cookie consent banners and GDPR compliance, checkout manipulation, subscription cancellation traps, humane design, ethical design review, or regulatory exposure to EU DSA, FTC click-to-cancel, or Digital Fairness Act (Brignull Deceptive Patterns; Nodder Evil by Design; Monteiro Ruined by Design). Not for: visual aesthetic tells like glassmorphism or Inter defaults (use core audit/ai-tells); legitimate persuasion mechanics (use behavioral); accessibility failures (use usability)."
user-invocable: true
